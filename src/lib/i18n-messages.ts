...
export const MESSAGES: Record<Locale, Messages> = {
  es: {
    ...
    'display.appt.pending': 'Cita · {name} · por confirmar',
    'display.appt.confirmed': 'Cita · {name}',
    'kiosk.appt.title': '¿Tienes cita con un barbero?',
    'kiosk.appt.no': 'No, vengo sin cita',
    'kiosk.appt.yes': 'Sí, tengo cita',
    'kiosk.appt.pick': '¿Con quién es tu cita?',
    'kiosk.appt.confirmTitle': '¿Tu cita es con {name}?',
    'kiosk.appt.confirmYes': 'Sí, es mi cita',
    'kiosk.appt.confirmNo': 'No, volver',
    'kiosk.success.appt': 'Estás en la fila de {name} — te llama cuando se desocupe',
    'kiosk.success.wrongBarber': '¿Te equivocaste de barbero? Corregir',
    'stats.cuts.apptSplit': '{appts} citas · {walkins} walk-ins',
  ...
  en: {
    ...
    'display.appt.pending': 'Appt · {name} · pending',
    'display.appt.confirmed': 'Appt · {name}',
    'kiosk.appt.title': 'Do you have an appointment with a barber?',
    'kiosk.appt.no': "No, I'm a walk-in",
    'kiosk.appt.yes': 'Yes, I have an appointment',
    'kiosk.appt.pick': 'Who is your appointment with?',
    'kiosk.appt.confirmTitle': 'Is your appointment with {name}?',
    'kiosk.appt.confirmYes': "Yes, that's my appointment",
    'kiosk.appt.confirmNo': 'No, go back',
    'kiosk.success.appt': "You're in {name}'s line — they'll call you when free",
    'kiosk.success.wrongBarber': 'Wrong barber? Fix it',
    'stats.cuts.apptSplit': '{appts} appts · {walkins} walk-ins',
