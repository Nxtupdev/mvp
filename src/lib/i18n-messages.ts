...
export const MESSAGES: Record<Locale, Messages> = {
  es: {
    ...
    'kiosk.success.appt': 'Avísale a {name} que llegaste — él confirma tu cita desde su celular',
  ...
  en: {
    ...
    'kiosk.success.appt': 'Let {name} know you arrived — they confirm your appointment from their phone',
